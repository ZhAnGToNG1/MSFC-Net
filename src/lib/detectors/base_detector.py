...
class BaseDetector(object):
    ...
    def pre_process_simple(self,image,meta=None):
        ...
        for scale in self.scales:
            ...
            for hh in range(0, imgH, h_len - h_overlap):
                ...
                for ww in range(0, imgW, w_len - w_overlap):
                    ...
                    src_img, meta1 = self.pre_process_simple(src_img, meta)
                    src_img = src_img.to(self.opt.device)


                    output , dets ,net_time = self.process(src_img, self.opt.patch_size,return_time=True)
