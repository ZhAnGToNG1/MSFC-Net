...
from models.utils import conv3x3
...
class ResNet(nn.Module):
    def __init__(self, block, layers, heads,head_conv, radix=1, groups=1, bottleneck_width=64
        ...
        self.para_conv = Parallel_conv(Pconv_num= 1, pconv_deform = True)
        ...
        self.fractal_conv_12 = conv3x3(256, 256, padding=1, stride=(1, 2))
        self.fractal_conv_21 = conv3x3(256, 256, padding=1, stride=(2, 1))
