...
class Debugger(object):
    def __init__(self, ipynb=False, theme='black',
                 num_classes=-1, dataset=None, down_ratio=2):
        self.ipynb = ipynb
        if not self.ipynb:
        ...
        elif num_classes == 10 or dataset == 'nwpu_vhr':
            self.names = nwph_vhr_class_name
        elif num_classes == 20 or dataset == 'pascal':
            self.names = pascal_class_name
        elif num_classes == 16 or dataset =='DOTA':
            self.names = DOTA_class_name
        elif num_classes == 20 or dataset == 'DIOR':
            self.names = DIOR_class_name
    ...
    def save_img(self, imgId='default', path='./cache/debug/',name = ''):
        cv2.imwrite(path + '/' + name +'{}.png'.format(imgId), self.imgs[imgId])
...
DIOR_class_name = ['golffield', 'Expressway-toll-station', 'vehicle', 'trainstation', 'chimney', 'storagetank', 'ship', 'harbor',
               'airplane', 'groundtrackfield',  'tenniscourt', 'dam', 'basketballcourt', 'Expressway-Service-area', 'stadium','airport','baseballfield',
